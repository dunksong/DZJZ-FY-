...
namespace EDRS.DALFactory
{
	...
	public sealed class DataAccess 
	{
        ...
        /// <summary>
        /// 创建TYYW_GG_AJJBXXKZ数据层接口。
        /// </summary>
        public static EDRS.IDAL.ITYYW_GG_AJJBXXKZ CreateTYYW_GG_AJJBXXKZ()
        {
            string ClassNamespace = AssemblyPath + ".TYYW_GG_AJJBXXKZ";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (EDRS.IDAL.ITYYW_GG_AJJBXXKZ)objType;
        }
