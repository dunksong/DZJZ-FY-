...
namespace EDRS.BLL
{
	...
	{
        private readonly IXT_DZJZ_ZZCS dal = DataAccess.CreateXT_DZJZ_ZZCS();
        public XT_DZJZ_ZZCS(System.Web.HttpRequest _context)
        {
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EDRS.Model.XT_DZJZ_ZZCS GetModelByCache(string MBJZBH)
		{

            string CacheKey = "XT_DZJZ_ZZCSModel-" + MBJZBH;
			...
			return (EDRS.Model.XT_DZJZ_ZZCS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
        public List<EDRS.Model.XT_DZJZ_ZZCS> GetModelList(string strWhere, params object[] objValues)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EDRS.Model.XT_DZJZ_ZZCS> DataTableToList(DataTable dt)
		{
			List<EDRS.Model.XT_DZJZ_ZZCS> modelList = new List<EDRS.Model.XT_DZJZ_ZZCS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EDRS.Model.XT_DZJZ_ZZCS model;
