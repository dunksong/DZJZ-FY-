...
{
    public class LogManagerExtention
    {
        #region 字段属性
        ...
        public static ILogExtention Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static ILogExtention Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static ILogExtention Exists(Assembly assembly, string name)
        {
        ...
        public static ILogExtention[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static ILogExtention[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static ILogExtention[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public static ILogExtention GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ILogExtention GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ILogExtention GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public static ILogExtention GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ILogExtention GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ILogExtention GetLogger(Assembly assembly, Type type)
        {
        ...
        private static ILogExtention WrapLogger(ILogger logger)
        {
            return (ILogExtention)s_wrapperMap.GetWrapper(logger);
        }
        ...
        private static ILogExtention[] WrapLoggers(ILogger[] loggers)
        {
            ILogExtention[] results = new ILogExtention[loggers.Length];
        ...
        {
            return new LogExtentionImplete(logger);
        }
