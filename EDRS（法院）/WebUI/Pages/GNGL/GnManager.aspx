...
<body>
    <div style="width: 900px; margin: 10px;">
        <div style="float: left; border-radius: 10px;float: left;overflow: hidden;" id="divleft">
            <div style=" width: 198px; height: 373px; overflow: auto;
                position: relative;">
                <ul id="tree_ZzjgSelectJs">
                </ul>
            </div>
        </div>
        <div style="float: left; width: 16px; padding: 10px; margin-top: 100px;" id="divmiddle" class="searchbartab">
        ...
        <div style="float: right; border-radius: 10px;overflow: hidden;" id="divright">
            <div id="mainGrid">
            </div>
        </div>
