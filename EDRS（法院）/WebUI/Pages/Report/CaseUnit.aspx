...
<body style="padding: 15px 15px 0px 15px; overflow: hidden;">
    ...
    <script type="text/javascript">
        ...
        $(function () {
         ...
         //alert();
         $("#mainGridAj").css("height",$(window).height()-110);
                ...
                { display: '制作状态', name: 'ISREGARD', align: 'center', width: 80,
                  ...
                  <% if (Ver_Advanced_Alone == "ADVANCED_ALONE")
                    ...
                    <% }
                       ...
                       { %>
                    { display: '案由', name: 'AJMC', width: 150 },
...
//                { display: '嫌疑人姓名', name: 'XYR', width: 200 },
              ...
              //  { display: '承办部门', name: 'CBBM_MC', width: 200 },                
                { display: '承办人', name: 'CBR', width: 100 },
                { display: '收案日期', name: 'SARQ', width: 100 ,render:function(item){
                    return item.SARQ.substring(0,10);
                }}, 
                { display: '结案日期', name: 'JARQ', width: 100,render:function(item){
                    return item.JARQ.substring(0,10);
                } },                

                { display: '归档日期', name: 'GDRQ', width: 100 ,render:function(item){
...
//                },
                ...
                usePager: true, enabledSort: false, width: '100%', height: '100%', heightDiff: 0,      //服务器分页
