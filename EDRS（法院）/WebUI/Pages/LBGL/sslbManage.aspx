    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            grid = $("#mainGrid").ligerGrid({
                ...
                { text: '增加卷', click: addDown, img: '../../images/NewAdd/cx.png' },
                //{ line: true },
                {text: '增加文件', click: addDownTo, img: '../../images/NewAdd/cx.png' },
                //{ line: true },
                {text: '修改', click: editData, img: '../../images/NewAdd/cx.png' },
                //{ line: true },
                {text: '删除', click: deleteData, img: '../../images/NewAdd/cx.png' }
                ]
