...
<body style="padding: 15px 15px 0px 15px; overflow: hidden;">
    ...
    <div id="top_div_to" style="display: none;border: 1px solid #ccc;background: white;padding: 5px;margin-bottom: 10px;border-radius: 10px;">
    ...
    <div id="layout" style="width: 100%; margin: 0; padding: 0; display: none;overflow: hidden;">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function resizeLayout() {
              ...
              //  $(".l-layout-center").css("width", width - 30 + "px");
                ...
                h = height - 40;
               // $(".l-layout-center").css("height", h +35 + "px");
              //  $(".l-layout-left").css("height", h +35 + "px");
            ...
            grid = $("#mainGrid").ligerGrid({
                ...
                //                { display: '犯罪嫌疑人姓名', name: 'XYR', minWidth: 150 },
                 {display: '归档日期', name: 'GDRQ', width: 150, render: function (item) {
                     if (item.GDRQ)
                         return item.GDRQ.substring(0, 10);
                 }
             },
                { display: '立案单位', name: 'CBDW_MC', width: 150 },
                { display: '承办人', name: 'CBR', width: 150 },
        ...
        function display() {
            ...
            if (cksld != null) {
                ...
                $("#span_ajname").html("当前卷宗：" + cksld.AJMC + "&nbsp;【" + cksld.BMSAH + "】");
