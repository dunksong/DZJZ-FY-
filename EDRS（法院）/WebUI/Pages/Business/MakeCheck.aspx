    ...
    <div id="top_div" style="overflow-x: auto;">
        <table class="searchbartab" border="0">
            <tr>
                ...
                <td style="">
                    <select id="sct_relevance" class="l-text" name="sct_relevance" style="width: 160px">
...
//                { display: '犯罪嫌疑人姓名', name: 'XYR', width: 150 },
                { display: '归档日期', name: 'GDRQ', width: 150 },
                    ...
                    $.ligerDialog.confirm('是否确定手动报送？', function (yes) {
                        if (yes) {
                            $.ajax({
                                type: "POST",
                                url: "MakeCheck.aspx",
                                data: { t: "sdsb", AJBH: row.BMSAH, WSBH: row.WSBH, ZZZT: row.ZZZT },
                                dataType: 'json',
                                timeout: 10000,
                                cache: false,
                                beforeSend: function () {
