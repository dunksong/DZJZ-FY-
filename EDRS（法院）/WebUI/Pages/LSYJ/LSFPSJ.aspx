...
<body style="margin: 0; overflow: hidden; padding: 10px;">
    <div style="padding-bottom: 5px;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <div id="btn_submitapplyall" style="width: auto; display: inline-block; vertical-align: bottom;
            display: none;">
        </div>
        <div id="btn_save" style="width: auto; display: inline-block; vertical-align: bottom;">
        </div>
        <div id="btn_dy" style="width: auto; display: inline-block; vertical-align: bottom;
            display: none;">
        </div>
    ...
    <div id="layout" style="width: 100%; margin: 0; padding: 0;">
        <div id="leftFrm" position="left" title='案件目录'>
            <ul id="path_tree">
                <li style="padding: 5px 5px;">确认阅卷是否已通过了审核,或者已阅卷！</li>
            </ul>
        </div>
    ...
    <script type="text/javascript">
                    ...
                    if (i == b.length - 1) {
                        ...
                        $.ligerDialog.confirm('确定提交申请吗?', function (yes) {
                            if (yes == true) {
                                ...
                                $.post("/Pages/LSYJ/LSFPSJ.aspx", { t: "submitapplyall", idstr: arr, ljstr: arrlj, yjxh: yjxh, lszh: lszh }, function (newData) {
                                    if (newData.t) {
                                        if (newData.t == "win") {
        ...
        function JZMLTree(bmsah) {
            if (bmsah) {
                ...
                path_tree = $("#path_tree").ligerTree({
                    ...
                    parms: { t: 'GetMlTree', bmsah: bmsah, yjxh: parent.GetQueryString(window.location.search.substr(1), "yjxh"), lszh: lszh, wjtype: "N" },
                    isExpand: 2,
                    checkbox: true,
                    treeLine: true,
                    slide: false,
        ...
        function sh(bmsah) {
            $.post("/Pages/LSYJ/LSFPSJ.aspx", { t: "IsSh", yjxh: yjxh, lszh: lszh }, function (data) {
