<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LSYJ.aspx.cs" Inherits="WebUI.Pages.LSYJ.LSYJ" %>
...
//            }
        ...
        if(node.data.ISLEAF=="0"){             
            ...
            $.post("/Pages/LSYJ/LSYJ.aspx", { t: "GetMlTree", level: 3, pid: node.data.id, ischecked: ischecked, yjxh: path_tree.options.parms.yjxh, bmsah: path_tree.options.parms.bmsah }, function (newData) {
                if (newData.t) {
