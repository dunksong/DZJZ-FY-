            ...
            <table style="line-height: 30px;">
                <tr>
                    ...
                    <td>
                        ...
                        <input id="txt_superior" class="l-text" type="text" name="txt_superior" disabled="disabled" style=" width:200px;" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input class="l-text" type="text" id="txt_number" name="txt_number" maxlength="50" style=" width:200px;" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="l-text" type="text" id="txt_abbreviation" name="txt_abbreviation" maxlength="30"style=" width:200px;"  />
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            grid = $("#mainGrid").ligerGrid({
                ...
                { text: '增加下级单位', click: addDown, img: '../../images/NewAdd/add.png' },
              //  { line: true },
