...
{
    public partial class PrintFrontCover : BasePage
    {
        ...
        private string AddData()
        {
          ...
          //  EDRS.BLL.YX_DZJZ_JZJBXX jbxxbll = new YX_DZJZ_JZJBXX(Request);
            ...
            if (!string.IsNullOrEmpty(ajmc) && !string.IsNullOrEmpty(ajlb))//&& !string.IsNullOrEmpty(ajbh)
            {
                ...
                modelkz.SARQ = string.IsNullOrEmpty(Request.Form.Get("txt_sasj"))? DateTime.Now: Convert.ToDateTime(Request.Form.Get("txt_sasj"));
                modelkz.JARQ = string.IsNullOrEmpty(Request.Form.Get("txt_jasj"))?DateTime.Now: Convert.ToDateTime(Request.Form.Get("txt_jasj"));
                ...
                modelkz.GDRQ = string.IsNullOrEmpty(Request.Form.Get("txt_gdrq"))? DateTime.Now: Convert.ToDateTime(Request.Form.Get("txt_gdrq"));
                ...
                string strstring = xtpz.CONFIGVALUE + "@" + linkType + "@" + callBack + "@" + bmsah + "@"+type; 
                #endregion
                ...
                if (bll.GetRecordCount(" and BMSAH=:BMSAH", new object[] { bmsah }) > 0)
                {
                    ...
                    OperateLog.AddLog(OperateLog.LogType.案件卷宗制作Web, "打印时保存数据失败", model.BMSAH, UserInfo, UserRole, this.Request);
