    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function resizeLayout() {
                ...
                $(".l-layout-left").height(height + 10);
                $(".l-layout-center").height(height + 10);
                $("#leftFrm").height(height-20);
            }
            //加载树
            ...
            grid = $("#mainGrid").ligerGrid({
                ...
                { text: '增加人员权限', click: addData, img: '../../images/NewAdd/add.png' },
                //{ line: true },
                { text: '删除人员权限', click: DelData, img: '../../images/NewAdd/sc.png' }
                ]
                }
            });
