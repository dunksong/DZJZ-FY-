...
a#btn_LBDel 
{
    ...
    background:#417C90;
        ...
        a#search2{
            color: white;
           border:none;
            background: rgb(73, 165, 166);margin-top: -3px;
    margin-left: 10px;
            }
            a#A1 
            {
                color: white;
           border:none;
                background: #427979;margin-top: -3px;
    margin-left: 10px;
            }
            a#btn_dwDel 
            {
        ...
        {
            background: url(../../images/NewAdd/cx.png) no-repeat;
            }
            .icon-add {
                background: url(../../images/Newadd/add.png) no-repeat;
            }
            .icon-remove 
            {
                background: url(../../images/Newadd/sc.png) no-repeat;
                }
...
<body style="background-color: white;">
    ...
    <div id="tt" class="easyui-tabs" style="width: 100%; height: 430px;" >
        <div title='<%=((VersionName)0).ToString() %>权限' style="overflow: auto; padding: 10px;
            ...
            <div style="float: left; width: auto; padding-top: 165px; margin: 0px 30px;">
            ...
            <div style= "float: right; margin-right:20px;width: auto;">
                <div style="height: 30px;">
        ...
        <div title="单位权限" id="aaa" style="padding: 10px; display: block;">
            ...
            <div style="float: left; text-align: center; width: auto; padding-top: 165px; margin: 0px 30px;">
