...
namespace EDRS.OracleDAL
{
	...
	public partial class XT_DM_QX:IXT_DM_QX
	{
        ...
        public DataSet GetQxListByRole(string dwbm, string bmbm, string gh, int type, string strWhere)
        {
            ...
            {
                EDRS.Common.LogHelper.LogError(this.context, "Exception", ex.Message, "public DataSet GetQxListByRole(string dwbm,string bmbm,string gh,int type)", "EDRS.OracleDAL.XT_DM_QX");
            }
            return null;
        }
        ...
        public DataSet GetDwQxList(string dwbm, string jsbms)
        {
            ...
            {
                EDRS.Common.LogHelper.LogError(this.context, "Exception", ex.Message, "public DataSet GetDwQxList(string dwbm,string bmbm,string gh,int type)", "EDRS.OracleDAL.XT_DM_QX");
            }
            return null;
        }
