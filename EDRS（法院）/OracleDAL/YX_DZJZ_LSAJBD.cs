...
namespace EDRS.OracleDAL
{
	...
	public partial class YX_DZJZ_LSAJBD:IYX_DZJZ_LSAJBD
    {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("SELECT count(1) from YX_DZJZ_LSYJSQ q left join  YX_DZJZ_LSAJBD T on q.yjsqdh=t.yjsqdh  ");           
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where 1=1 "+strWhere);
			}
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params object[] objValues)
        {
            ...
            strSql.Append(@")AS Ro,T.*,j.ajbh,j.wsbh,j.wsmc,q.sqsm,q.yjsqdm,q.shr,q.shrgh,q.shsj,q.sqdzt,q.lszh,q.shsm,l.LSXM,l.LSDW,l.LSDWDZ
,l.LSLXDH,l.DELXR,b.bmmc from YX_DZJZ_LSYJSQ q 
                         left join YX_DZJZ_LSGL l on q.lszh = l.lszh
                         left join  YX_DZJZ_LSAJBD T on q.yjsqdh=t.yjsqdh 
                         left join yx_dzjz_jzjbxx j on t.bmsah=j.bmsah  
                         left join xt_zzjg_bmbm b on q.SQSM = b.bmbm and b.dwbm = t.dwbm ");
