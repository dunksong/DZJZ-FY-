...
namespace EDRS.OracleDAL
{
	...
	public partial class YX_DZJZ_JZJBXX
    {
        ...
        public int GetRecordCountPower(string strWhere, params object[] objValues)
		{
            ...
            strSql.AppendFormat(" join tyyw_gg_ajjbxxkz d on t.bmsah = d.ahmc left join TYYW_GG_AJJBXX{0} aj on T.BMSAH = aj.BMSAH", ConfigHelper.GetConfigString("OrcDBLinq"));
        ...
        public DataSet GetListByPagePower(string strWhere, string orderby, int startIndex, int endIndex, params object[] objValues)
		{
            ...
            strSql.AppendFormat(" join tyyw_gg_ajjbxxkz{0} d on t.bmsah=d.ahmc", ConfigHelper.GetConfigString("OrcDBLinq"));
