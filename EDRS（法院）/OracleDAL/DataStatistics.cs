...
namespace EDRS.OracleDAL
{
    ...
    public partial class DataStatistics : IDataStatistics
    {
        ...
        public DataSet GetDwJzZzQuery(string strWhere, string dwbm, string gh, string orderby, int startIndex, int endIndex, out int count, params object[] objValues)
        {
            ...
            try
            {
                DataSet ds = DbHelperOra.RunProcedure("pkg_dzjz_report.proc_report_dwjzzzcx_fy", parameters, "proc_report_dwjzzzcx_fy");
            ...
            {
                EDRS.Common.LogHelper.LogError(this.context, "Exception", ex.Message, "public DataSet GetDwJzZzQuery(string strWhere, string orderby, int startIndex, int endIndex, params object[] objValues)", "EDRS.OracleDAL.DataStatistics", "pkg_dzjz_report.proc_report_dwjzzzcx_fy", parameters);
            }
            count = 0;
            return null;
        } 
        ...
        public DataTable GetYJTJ(string strWhere,string strWhereAj,string strWhereRy, string orderby, int startIndex, int endIndex, out int count, params object[] objValues)
        {
            ...
            try
            {
                DataSet ds = DbHelperOra.RunProcedure("pkg_dzjz_report.proc_report_getzzl_fy", parameters, "proc_report_getzzl_fy");
                count = Convert.ToInt32(parameters[6].Value);
                //OracleParameter op = parameters.FirstOrDefault(d => d.ParameterName == "p_count1");//.Value.ToString();
                //if (op != null)
                //    count = Convert.ToInt32(op.Value);
            ...
            {
                EDRS.Common.LogHelper.LogError(this.context, "Exception", ex.Message, "public DataSet GetYJTJ(string strWhere,string strWhereAj, string orderby, int startIndex, int endIndex, out int count, params object[] objValues)", "EDRS.OracleDAL.DataStatistics", "pkg_dzjz_report.proc_report_getzzl_fy", parameters);
            }
            count = 0;
            return null;
