...
namespace EDRS.IDAL
{
	...
	public interface ITYYW_GG_AJJBXX : ILogBase
	{
        ...
        /// 增加一条数据
        /// </summary>
        bool AddList(EDRS.Model.TYYW_GG_AJJBXX model, EDRS.Model.TYYW_GG_AJJBXXKZ modelkz, EDRS.Model.YX_DZJZ_JZJBXX modeljbxx);

        bool UpdateList(EDRS.Model.TYYW_GG_AJJBXX model, EDRS.Model.TYYW_GG_AJJBXXKZ modelkz, EDRS.Model.YX_DZJZ_JZJBXX modeljbxx);
		#endregion  扩展接口
	} 
}
