...
namespace EDRS.OracleDAL
{
	...
	public partial class XT_ZZJG_RYBM:IXT_ZZJG_RYBM
    {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params object[] objValues)
		{
            ...
            strSql.AppendFormat(")AS Ro, T.GH,T.DWBM,T.MC,T.DLBM,T.KL,T.YDDHHM,T.DZYJ,T.GZZH,T.YDWBM,T.YDWMC,T.SFLSRY,T.SFTZ,T.SFSC,T.XB,T.CAID,T.ZW  from XT_ZZJG_RYBM{0} T ", ConfigHelper.GetConfigString("OrcDBLinq"));
