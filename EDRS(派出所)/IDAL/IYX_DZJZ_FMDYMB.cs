...
namespace EDRS.IDAL
{
	...
	/// 接口层电子卷宗封面打印模板
	/// </summary>
    public interface IYX_DZJZ_FMDYMB : ILogBase
	{
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		/// 增加一条数据
		/// </summary>
		bool Add(EDRS.Model.YX_DZJZ_FMDYMB model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(EDRS.Model.YX_DZJZ_FMDYMB model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		EDRS.Model.YX_DZJZ_FMDYMB GetModel(string BM);
		EDRS.Model.YX_DZJZ_FMDYMB DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
