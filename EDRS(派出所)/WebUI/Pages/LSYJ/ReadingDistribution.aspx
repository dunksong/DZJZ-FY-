...
<body style="margin: 0; overflow: hidden; padding: 10px;" id="searchbar">
                ...
                $.ligerDialog.show({ title: '选择'+vn, target: $('#select_div'), width: 780,
                    buttons: [{ text: '确定', onclick: function (item, dialog) {
                        ...
                        if (grdata != null && grdata.BMSAH != null) {
                            ...
                            $("#span_ajname").html("当前卷宗：" + grdata.AJMC + "&nbsp;【" + grdata.AJBH + "】");
                            dialog.hidden();
                        } else {
                ...
                columns: [
                 ...
                 <%  if (Ver_Advanced_Alone == "ADVANCED_ALONE")
                    ...
                    <% }
                       ...
                       { %>
                     {display: '案件编号', name: 'AJBH', minWidth: 280,  },
...
//                        { display: '登录别名', name: 'DLBM', minWidth: 100 },
                        { display: '职务', name: 'ZW', minWidth: 100 },
        ...
        function gridSetParm() {
            ...
            grid.setParm("relevance","2,3,4,5,6");
        }
    </script>
</body>
