<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FullQueryDetailed.aspx.cs"
    Inherits="WebUI.FullQueryDetailed" %>
...
<body style="padding: 6px; overflow: hidden;">
    <div>
        <table class="table-d" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            ...
            <tr>
                ...
                <td id="td-content">
                    <iframe id="pdfFrm" name="pdfFrm" src="" style="height: 600px; width: 100%;" frameborder="0">
                    </iframe>
                </td>
            </tr>
        </table>
    ...
    <script type="text/javascript">
        ...
        //动态生成的用live绑定事件
        $(function () {
            $("#pdfFrm").height($(window).height()-85);
            search();
        });
        function search() {
                    ...
                    success: function (data) {
                        ...
                        if (data.response) {
                            ...
                            $.each(data, function (i, n) {
                                ...
                                $("#td_ajmc").text(n.AJMC);
                                // $("#td_slrq").text(n.ZHXGSJ);
                                // $("#td_cbr").text(n.CBR);
                                $("#td_wjmc").text(n.WJXSMC);
                                //$("#td-content").text(n.WSCFLJ);
                                $("#pdfFrm").attr("src", "/Pages/Business/FullQueryReadingFile.aspx?wjmc=" + n.WJMCDZJZ + "&wjlj=" + n.JZWJLJ + "");
                            });
                        } else {
                            if (data.t) {
