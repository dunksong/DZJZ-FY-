    ...
    <script type="text/javascript">
        ...
        function SearchData(type, catvalue) {
            ...
            if (type == "pic") {
                ...
                picGrid = $("#mainGrid").ligerPanel({ title: '卷宗月统计图', width: '100%', showToggle: false, height: 560, url: 'ReportCenter.aspx?action=caseByMouth&type=bar&' + where + '' });
                $("#mainGrid").show();
            }
            else {
                ...
                { display: '文件页数', name: 'pagecount', minWidth: 70, totalSummary: { type: 'sum'} },
                    ...
                    usePager: false, enabledSort: true, width: '100%', height: '100%', heightDiff: -10,       //服务器分页
