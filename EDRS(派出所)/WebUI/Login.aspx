...
<head id="Head1">
    ...
    <style type="text/css">
        ...
        #aLogin
        {
            background: url('/images/bt_dl_normal.png') no-repeat -10px 0;
        }
        #aLogin:hover
        {
            background: url('/images/bt_dl_hover.png') no-repeat -10px 0;
        }
        
        #aclose
        {
            background: url('/images/bt_q_normal.png') no-repeat -10px 0;
        }
        #aclose:hover
        {
            background: url('/images/bt_qx_hover.png') no-repeat -10px 0;
        }
...
<body style="margin: 0; background:#258dcc;">
    ...
    <div id="centent" style="border: 0; width: 834px; height: 405px;background: url(/images/di.jpg) no-repeat -261px -130px;">
        ...
        <table class="tableform" align="center" style="text-align: center; position: absolute;
            width: 238px; margin-top: 163px; margin-left: 386px; font-size: 10pt" cellpadding="0"
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <input id="tree_select" name="tree_select" data-options="required:true" missingmaessage="必须选择所属院"
                        style="width: 269px; height: 30px;" value="">
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <input id="txtUser" type="text" class="input2 textbox" missingmaessage="用户名必须输入,最多20字符。"
                        validtype="length[1,20]" data-options="required:true" style="width: 237px; height: 32px;
                        border: 0px;" name="txtUser" value="" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="3" align="center" style="text-align: left;">
                    <a id="aLogin" style="color: #666666;
                                    ...
                                    width: 41px;
                                    border-radius: 5px;" href="javascript:void(0);"></a>
                        <a id="aclose" style="    color: #666666;
                        display: inline-block;
                        height: 21px;
                        float: right;
                        margin-right: 1px;
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#tree_select").val("");
            dwbm_tree = $("#tree_select").unitJuris({ url: "/Login.aspx", width: 238 });
