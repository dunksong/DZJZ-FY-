...
$(function () {
    ...
    $("#searchbar .l-button,#add_form .l-button,#top_div_to .l-button,.searchbartab .l-button,#tb .l-button,#tb_search .l-button").each(function (index) {
        $(this).addClass("l-button-" + index);
        for (var k = 0; k <= index; k++) {
            $(".l-button-" + k).css({ background: cc[k], color: "white", borderRadius: "5px" ,height:"25px",lineHeight:"25px"});
        }
    });
    //禁止按钮
