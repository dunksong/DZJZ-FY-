(function ($) {
    $.fn.unitJuris = function (defaults) {
        ...
        var DwbmTree = $(this).ligerComboBox({
            ...
            selectBoxWidth: 300,
            selectBoxHeight: 300,
            initValue:defaults.initValue ? defaults.initValue :null,
            initText :defaults.initText ? defaults.initText :null,
            ...
            onSuccess: function (data) {
                if (data.t) {
                    ...
                    if (defaults.defaultValue && defaults.defaultValue != "") {
                        DwbmTree.setValue(defaults.defaultValue);    
                    }
